...
create table if not exists public.turnos (
  ...
  -- Se conservan los estados históricos porque la base existente los utiliza.
  -- La interfaz actual normaliza visualmente los estados heredados.
  ...
  origen text not null default 'panel' check (origen in ('panel', 'whatsapp', 'reserva_web'))
);
...
create table if not exists public.horarios_barbero (
  ...
  unique (barbero_id, day_of_week, start_time, end_time)
);
