...
function makeSeed() {
  ...
  const conversaciones = [
    { id: 1401, paciente: 'Agustín Molina', clienteId: 1200, ultimaHora: '10:42', noLeido: true, mensajes: [{ de: 'paciente', texto: 'Hola, ¿tienen turno hoy?', hora: '10:40' }, { de: 'bot', texto: 'Sí, podés reservar desde tu página de turnos.', hora: '10:41' }, { de: 'paciente', texto: 'Perfecto, gracias.', hora: '10:42' }] },
    { id: 1402, paciente: 'Bruno Acosta', clienteId: 1201, ultimaHora: '09:15', noLeido: true, mensajes: [{ de: 'paciente', texto: '¿Hay disponibilidad para mañana por la tarde?', hora: '09:14' }, { de: 'bot', texto: 'Hay horarios disponibles. Te mostramos las opciones.', hora: '09:15' }] },
    { id: 1403, paciente: 'Carla Benítez', clienteId: 1202, ultimaHora: 'ayer', noLeido: false, mensajes: [{ de: 'bot', texto: 'Recordatorio: tu turno está confirmado.', hora: 'ayer' }, { de: 'paciente', texto: 'Gracias, ahí estaré.', hora: 'ayer' }] },
    { id: 1404, paciente: 'Damián Ríos', clienteId: 1203, ultimaHora: 'lunes', noLeido: false, mensajes: [{ de: 'paciente', texto: 'Quisiera sacar un turno para corte y barba.', hora: 'lunes' }, { de: 'bot', texto: 'Claro, elegí el día y el horario que prefieras.', hora: 'lunes' }] },
  ]
