...
- Falta repetir el smoke visual autenticado directamente en el deploy QA con
  una sesión owner/admin disponible en el navegador; la evidencia autenticada
  versionada sigue siendo la referencia actual.
- Falta ejecutar la matriz completa de CI/E2E de este commit y confirmar el
  deployment QA posterior. No se declara todavía el estado final aprobado.
...
No se encontraron P0. Los hallazgos P1/P2 identificados en las superficies
visitadas quedaron corregidos y verificados visualmente en local QA. El cierre
formal queda condicionado a las verificaciones automatizadas y al smoke del
deploy QA.
